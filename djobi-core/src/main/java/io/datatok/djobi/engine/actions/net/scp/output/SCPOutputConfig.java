...
public class SCPOutputConfig extends ActionConfiguration {
    String host;
    Integer port;
    String user;
    String password;
    ...
    public SCPOutputConfig(final Bag stageConfiguration, final Job job, final TemplateUtils templateUtils) {
